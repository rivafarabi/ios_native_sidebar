...
class MockIosNativeSidebarPlatform
    with MockPlatformInterfaceMixin
    implements IosNativeSidebarPlatform {
  @override
  Future<String?> getPlatformVersion() => Future.value('42');
}

void main() {
  final IosNativeSidebarPlatform initialPlatform =
      IosNativeSidebarPlatform.instance;
